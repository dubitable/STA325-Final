...
results <- data.frame(
  Model = c("Cumu. Logit", "Linear SVM", "Radial SVM", "RandForest", "OrdForest", "Boosted."),
  Acc = c(0.61, 0.62, 0.63, 0.60, 0.61, 0.33),
  QWK = c(0.35, 0.32, 0.32, 0.32, 0.31, 0.25),
  MAE = c(0.96, 0.56, 0.57, 0.55, 0.56, 0.96)
)

kable(results, caption = "Model performance comparison: Accuracy (Acc), QWK, and MAE.") |>
