...
```{r Figure 1, fig.cap = "The distribution of categorical data collected from the 2015 BRFSS survey along with respective diabetes class", message=FALSE, warning=FALSE, echo=FALSE, fig.height=4, fig.width=8}
...
```{r Figure 2, fig.cap = "Count of observations within each diabetes class", message=FALSE, warning=FALSE, echo=FALSE, fig.height=4, fig.width=8}
