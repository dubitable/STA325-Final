...
Additionally, the method with which we measured accuracy was not simply predictive accuracy: we optimized our thresholds for the model as the purpose of our model is to not minimize false positives, but false negatives instead as misdiagnosing a patient who actually has diabetes is more costly.
